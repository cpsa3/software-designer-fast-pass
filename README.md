...
专治“抽象概念看字犯困”，采用矢量级混合图谱规范（Mermaid + 教材级 SVG + 标准 PlantUML），100% 离线跨平台兼容：
* 🌲 **[01-算法核心设计原理全景图解.md](./02-visual-diagrams/01-算法核心设计原理全景图解.md)**：分治法“分-治-合”倒树模型、动态规划 0-1 背包填表决策流、贪心 vs 动规抉择分歧、回溯法解空间树 DFS 剪枝全景图。
* 📐 **[02-UML核心建模图谱.md](./02-visual-diagrams/02-UML核心建模图谱.md)**：工业级代码建模标准，语法 100% 对应 OMG UML 2.5 国际规范，全量收录 9 大核心设计与运行视图及考场标志物对照表。
* 🎯 **[03-设计模式核心图谱与真题命题密码.md](./02-visual-diagrams/03-设计模式核心图谱与真题命题密码.md)**：GoF 23 种设计模式通关重器（决战全卷 20~25 分），ABC 考频梯队、23 模式 6 维全解（生活类比 + 真题原型 + PlantUML 类图 + C++/Java 挖空靶点）、5 大孪生决斗矩阵与考场特征词一秒速杀总表。
* 🌲 **[04-常见数据结构核心图谱与真题命题密码.md](./02-visual-diagrams/04-常见数据结构核心图谱与真题命题密码.md)**：常见数据结构考霸视觉图解专著，直击上午 6~10 分与下午试题四算法底层。矩阵压缩特值法、二叉树 5 大数学命题性质、中序定海神针反向切分、AVL 四种旋转、图遍历与 MST、8 大内部排序全景大表与建堆调整。
* 🚀 *持续补充中：计算机体系结构、操作系统存储变换、网络协议时序、数据库三级封锁等独立深度视觉专题...*
...
## 🛠️ 工程规约与技术架构：[docs/specs/](./docs/specs/)

* 📄 **[Markdown技术文档绘图方案全景调研与工程最佳实践.md](./docs/specs/Markdown技术文档绘图方案全景调研与工程最佳实践.md)**：4大技术流派纵览、Mermaid / PlantUML / D2 / Draw.io 深度横评、大厂 Docs-as-Code 最佳实践与本库规范。
