...
专治“抽象概念看字犯困”，采用矢量级混合图谱规范（Mermaid + 教材级 SVG），100% 离线跨平台兼容：
* 🛠️ **[00-Markdown技术文档绘图方案全景调研与工程最佳实践.md](./02-visual-diagrams/00-Markdown技术文档绘图方案全景调研与工程最佳实践.md)**：4大技术流派纵览、Mermaid / PlantUML / D2 / Draw.io 深度横评、大厂 Docs-as-Code 最佳实践与本库规范。
* 🌲 **[01-算法核心设计原理全景图解.md](./02-visual-diagrams/01-算法核心设计原理全景图解.md)**：分治法“分-治-合”倒树模型、动态规划 0-1 背包填表决策流、贪心 vs 动规抉择分歧、回溯法解空间树 DFS 剪枝全景图。
* 📐 **UML 核心建模图谱专题（提供 3 套版本自由选择）**：
  * 🌟 **[02-UML核心建模图谱-方案B-教材级高保真SVG版.md](./02-visual-diagrams/02-UML核心建模图谱-方案B-教材级高保真SVG版.md)**【★推荐】：100% 像素级复刻官方教材原图（火柴人、3D立方体、球窝接口），全平台免插件直接秒开，考场视觉零偏差！
  * 🛠️ **[02-UML核心建模图谱-方案A-PlantUML版.md](./02-visual-diagrams/02-UML核心建模图谱-方案A-PlantUML版.md)**：工业级代码建模标准，语法 100% 对应 OMG UML 2.5 国际规范。
  * ⚡ **[02-UML核心建模图谱与设计视图全景图解.md](./02-visual-diagrams/02-UML核心建模图谱与设计视图全景图解.md)**：纯原生 Mermaid 矢量版，零外部文件依赖，暗黑模式自适应。
